/*
 * Bye.java - Represents a Bye message for disconnecting from a peer
 * 
...
public class Bye extends Message {
	...
	public Bye(PeerInfo sender, PeerInfo receiver, int TTL){
		super(sender, receiver, Message.Type.BYE, TTL);		
	}
}
